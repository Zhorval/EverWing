...
protocol MovementNodes {
    associatedtype T = Enemy
    
    func move(dir: MoveStyle,node:T)
}

enum MoveStyle:MovementNodes,CaseIterable{
...
class Pinky:Enemy{
 ...
 /*   internal func attack(){
    ...
    func multiply(){
        ...
        cloneOne.move(dir: .Left, node: cloneOne)
        cloneTwo.move(dir: .Right,node:cloneTwo)
