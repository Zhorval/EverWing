...
let global:Global = Global.sharedInstance 

protocol GlobalAction {}
...
class Global {
    ...
    enum Main:String,CaseIterable,GlobalAction{
        ...
        case Character_Beta = "character_menu_2"
        ...
        case Character_Celta = "character_menu_3"
        ...
        case Character_Delta = "character_menu_4"
    ...
    private func mapPreload(){
        self.map[.Ragnarok]! = SKTextureAtlas(named: "Map").loadAtlas(name: "Map", prefix: "map1_")
